...
**Credits**
- App built in `Python` + `Streamlit` by [Prashant Kesharwani](https://www.linkedin.com/in/kesharwanip/)
...
st.sidebar.subheader('Clothing and Accessories')
option_accessories_type = st.sidebar.selectbox('Accessories Type',
                                                list_accessories_type,
                                                index = index_accessories_type)
option_clothe_type = st.sidebar.selectbox('Cloth Type',
                                           list_clothe_type,
                                           index = index_clothe_type)
option_clothe_color = st.sidebar.selectbox('Cloth Color',
                                            list_clothe_color,
                                            index = index_clothe_color)
option_clothe_graphic_type = st.sidebar.selectbox('Cloth Graphic Type',
